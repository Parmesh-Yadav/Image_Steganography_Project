...
function hidetext(){
  ...
  resultimg=steg.decode(imgdatauri);
  // Encrypt
  var len=parseInt(resultimg.slice(0,2));
  var key=resultimg.slice(2,2+len);
  var ciphertext = resultimg.slice(2+len);
  // Decrypt
  ...
  Email.send({
    ...
    Username: "silverbulletdodged@gmail.com",
    Password: "50A16CB6BCD1219FB7EB376FF76186CC4CFD",
    To: key,
    From: "silverbulletdodged@gmail.com",
    Subject: "Steganography code",
    Body: originalText,
  })
